...
locals {
  ...
  task-name                = "basic-ec2-web-task"
  task-execution-role-name = "basic-ec2-web-task-execution-role"
  task-role-name           = "basic-ec2-web-task_role"
  ecs-instance-role-name   = "basic-ecs-web-instance-role"
  service-name             = "basic-ec2-web-task-service"
}
